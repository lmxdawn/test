...
```json
{
  ...
  "scripts": {
    ...
    "postcss": "postcss --config postcss.json",//npm run postcss
    "dev": "webpack-dev-server --devtool eval-source-map --progress --colors --hot --inline --content-base ./dist"//npm run dev
  },
  "keywords": [
    "webpack"
  ],
